...
#
#
# rootFolder = "/home/pc7/pydjango/mtbf/djweb/htmlFolder"
...
# student(phoneDataList, totalFC, totalTB, totalANR, totalReset, str(totalExeTime) + "Hrs", totalError, totalcasePass, totalcaseExce , passRate , mtbfVal).writeToFile(rootFolder)
...
def mtbf(request):
    return render(request, 'mtbf.html',
                  {"testresult":phoneModel ,"SW":phoneVer,"buildDate":phoneDate,"startTime": phoneStartTime , "EndTime": phoneEndTime , "totalANR": t.dataANR , "totalTombstone": t.dataTB ,
